	...
	public static class ObjExporter
	{
		...
		static void ExportSelectionToSeparate()
		{
			for (int i = 0; i < Selection.gameObjects.Length; i++)
			{
				...
				if (avatar != null)
				{
					//"J:/Research21Spring/Assets/saved/obj" + avatar.name + ".obj";
					var path = "J:/Research21Spring/Assets/saved/objs/F"+i+ ".obj"; //EditorUtility.SaveFilePanel("Save obj static mesh", "Assets", avatar.name + ".obj", "obj");
					Debug.Log(path);
					if (path.Length != 0)
					{
